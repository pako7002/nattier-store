-- Script seguro para recrear la base de datos
-- Maneja las restricciones de claves foráneas correctamente
...
SELECT '✅ Base de datos Nattier Store instalada correctamente' as resultado;
